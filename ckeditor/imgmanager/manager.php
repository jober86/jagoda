...
<script type="text/javascript" src="<?php print $IMConfig['base_url'];?>lang/<?php print $_GET['langCode'];?>.js"></script>
<?php if (!empty($IMConfig['use_color_pickers'])) { ?><script type="text/javascript" src="<?php print $IMConfig['base_url'];?>ColorPicker/ColorPicker.js"></script><?php } ?>
...
<tr><td style="padding:10px; padding-top:0px;">
	<div id="messages" style="display: none;"><span id="message">Loading</span><img src="<?php print $IMConfig['base_url'];?>img/dots.gif" width="22" height="12" alt="..." /></div>
